...
public class ImageRGB extends Rasterizer
{
	...
	private void shapeImageToPixels( int[] pixels, int[] rasterizerPixels, int pixel, int rasterizerPixel, int width, int height, int pixelOffset, int rasterizerPixelOffset, int pixelColor )
	{
		int shiftedWidth = - ( width >> 2 );
		width = - ( width & 0x3 );
		for( int heightCounter = - height; heightCounter < 0; heightCounter ++ ) {
	...
	public void shapeImageToPixels( int i, int i_89_, int[] is, int i_90_, int[] is_91_, int i_93_, int i_94_, int i_95_, int i_96_, int i_97_ )
	{
		int i_98_ = - i_96_ / 2;
		int i_99_ = - i / 2;
