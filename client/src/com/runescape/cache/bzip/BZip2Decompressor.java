...
public class BZip2Decompressor {
	...
	while (bool_33_) {
		...
		BZip2Decompressor.method171(bzip2context.anIntArrayArray131[i_51_], bzip2context.anIntArrayArray132[i_51_], bzip2context.anIntArrayArray133[i_51_], bzip2context.aByteArrayArray130[i_51_], i_52_, b_53_, i_39_);
		...
		if ((i_68_ == 0) || (i_68_ == 1)) {
			...
			if (bzip2context.anIntArray127[0] == 0) {
				...
				for (int i_80_ = 15; i_80_ >= 0; i_80_--) {
				    bzip2context.aByteArray126[i_78_] = bzip2context.aByteArray126[bzip2context.anIntArray127[i_79_] + i_80_];
				    i_78_--;
				}
