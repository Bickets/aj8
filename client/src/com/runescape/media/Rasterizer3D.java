...
public class Rasterizer3D extends Rasterizer {
	...
	if (Rasterizer3D.anInt1497 > 0) {
		...
		if (Rasterizer3D.anIntArrayArray1499[i_18_] != null && (Rasterizer3D.anIntArray1500[i_18_] < i_16_ || i_17_ == -1)) {
    ...
    public static final void method371(int i, int i_53_, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_, int i_60_) {
	int i_61_ = 0;
	int i_62_ = 0;
	if (i_53_ != i) {
	...
	if (i <= i_53_ && i <= i_54_) {
		...
		if (i_53_ < i_54_) {
			...
			while (--i_53_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i, 0, 0, i_57_ >> 16, i_55_ >> 16, i_60_ >> 7, i_58_ >> 7);
			    i_57_ += i_65_;
			    i_55_ += i_61_;
			    i_60_ += i_66_;
			    i_58_ += i_62_;
			...
			while (--i_54_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i, 0, 0, i_57_ >> 16, i_56_ >> 16, i_60_ >> 7, i_59_ >> 7);
			    i_57_ += i_65_;
			    i_56_ += i_63_;
			    i_60_ += i_66_;
			    i_59_ += i_64_;
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_53_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i, 0, 0, i_55_ >> 16, i_57_ >> 16, i_58_ >> 7, i_60_ >> 7);
			    i_57_ += i_65_;
			    i_55_ += i_61_;
			    i_60_ += i_66_;
			    i_58_ += i_62_;
			...
			while (--i_54_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i, 0, 0, i_56_ >> 16, i_57_ >> 16, i_59_ >> 7, i_60_ >> 7);
			    i_57_ += i_65_;
			    i_56_ += i_63_;
			    i_60_ += i_66_;
			    i_59_ += i_64_;
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_54_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i, 0, 0, i_56_ >> 16, i_55_ >> 16, i_59_ >> 7, i_58_ >> 7);
			    i_56_ += i_65_;
			    i_55_ += i_61_;
			    i_59_ += i_66_;
			    i_58_ += i_62_;
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_54_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i, 0, 0, i_55_ >> 16, i_56_ >> 16, i_58_ >> 7, i_59_ >> 7);
			    i_56_ += i_65_;
			    i_55_ += i_61_;
			    i_59_ += i_66_;
			    i_58_ += i_62_;
		...
		if (i_54_ < i) {
			...
			while (--i_54_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i_53_, 0, 0, i_55_ >> 16, i_56_ >> 16, i_58_ >> 7, i_59_ >> 7);
			    i_55_ += i_61_;
			    i_56_ += i_63_;
			    i_58_ += i_62_;
			    i_59_ += i_64_;
			...
			while (--i >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i_53_, 0, 0, i_55_ >> 16, i_57_ >> 16, i_58_ >> 7, i_60_ >> 7);
			    i_55_ += i_61_;
			    i_57_ += i_65_;
			    i_58_ += i_62_;
			    i_60_ += i_66_;
			...
			i_53_ = Rasterizer3D.lineOffsets[i_53_];
			while (--i_54_ >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i_53_, 0, 0, i_56_ >> 16, i_55_ >> 16, i_59_ >> 7, i_58_ >> 7);
			    i_55_ += i_61_;
			    i_56_ += i_63_;
			    i_58_ += i_62_;
			    i_59_ += i_64_;
			...
			while (--i >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i_53_, 0, 0, i_57_ >> 16, i_55_ >> 16, i_60_ >> 7, i_58_ >> 7);
			    i_55_ += i_61_;
			    i_57_ += i_65_;
			    i_58_ += i_62_;
			    i_60_ += i_66_;
			...
			i_53_ = Rasterizer3D.lineOffsets[i_53_];
			while (--i >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i_53_, 0, 0, i_57_ >> 16, i_56_ >> 16, i_60_ >> 7, i_59_ >> 7);
			    i_57_ += i_61_;
			    i_56_ += i_63_;
			    i_60_ += i_62_;
			    i_59_ += i_64_;
			...
			i_53_ = Rasterizer3D.lineOffsets[i_53_];
			while (--i >= 0) {
			    Rasterizer3D.method372(Rasterizer.pixels, i_53_, 0, 0, i_56_ >> 16, i_57_ >> 16, i_59_ >> 7, i_60_ >> 7);
			    i_57_ += i_61_;
			    i_56_ += i_63_;
			    i_60_ += i_62_;
			    i_59_ += i_64_;
		...
		if (i_63_ < i_65_) {
		    ...
		    while (--i >= 0) {
			Rasterizer3D.method372(Rasterizer.pixels, i_54_, 0, 0, i_56_ >> 16, i_57_ >> 16, i_59_ >> 7, i_60_ >> 7);
			i_56_ += i_63_;
			i_57_ += i_65_;
			i_59_ += i_64_;
			i_60_ += i_66_;
		    ...
		    while (--i_53_ >= 0) {
			Rasterizer3D.method372(Rasterizer.pixels, i_54_, 0, 0, i_56_ >> 16, i_55_ >> 16, i_59_ >> 7, i_58_ >> 7);
			i_56_ += i_63_;
			i_55_ += i_61_;
			i_59_ += i_64_;
			i_58_ += i_62_;
		    ...
		    i_54_ = Rasterizer3D.lineOffsets[i_54_];
		    while (--i >= 0) {
			Rasterizer3D.method372(Rasterizer.pixels, i_54_, 0, 0, i_57_ >> 16, i_56_ >> 16, i_60_ >> 7, i_59_ >> 7);
			i_56_ += i_63_;
			i_57_ += i_65_;
			i_59_ += i_64_;
			i_60_ += i_66_;
		    ...
		    while (--i_53_ >= 0) {
			Rasterizer3D.method372(Rasterizer.pixels, i_54_, 0, 0, i_55_ >> 16, i_56_ >> 16, i_58_ >> 7, i_59_ >> 7);
			i_56_ += i_63_;
			i_55_ += i_61_;
			i_59_ += i_64_;
			i_58_ += i_62_;
		...
		if (i_63_ < i_65_) {
		    ...
		    i_54_ = Rasterizer3D.lineOffsets[i_54_];
		    while (--i_53_ >= 0) {
			Rasterizer3D.method372(Rasterizer.pixels, i_54_, 0, 0, i_55_ >> 16, i_57_ >> 16, i_58_ >> 7, i_60_ >> 7);
			i_55_ += i_63_;
			i_57_ += i_65_;
			i_58_ += i_64_;
			i_60_ += i_66_;
		    ...
		    i_54_ = Rasterizer3D.lineOffsets[i_54_];
		    while (--i_53_ >= 0) {
			Rasterizer3D.method372(Rasterizer.pixels, i_54_, 0, 0, i_57_ >> 16, i_55_ >> 16, i_60_ >> 7, i_58_ >> 7);
			i_55_ += i_63_;
			i_57_ += i_65_;
			i_58_ += i_64_;
			i_60_ += i_66_;
	...
	if (Rasterizer3D.textured) {
		...
		while (--i_68_ >= 0) {
		    ...
		    is[i++] = i_67_ + ((is[i] & 0xff00ff) * i_74_ >> 8 & 0xff00ff) + ((is[i] & 0xff00) * i_74_ >> 8 & 0xff00);
		    is[i++] = i_67_ + ((is[i] & 0xff00ff) * i_74_ >> 8 & 0xff00ff) + ((is[i] & 0xff00) * i_74_ >> 8 & 0xff00);
		    is[i++] = i_67_ + ((is[i] & 0xff00ff) * i_74_ >> 8 & 0xff00ff) + ((is[i] & 0xff00) * i_74_ >> 8 & 0xff00);
		    is[i++] = i_67_ + ((is[i] & 0xff00ff) * i_74_ >> 8 & 0xff00ff) + ((is[i] & 0xff00) * i_74_ >> 8 & 0xff00);
		}
		...
		do {
		    ...
		    is[i++] = i_67_ + ((is[i] & 0xff00ff) * i_77_ >> 8 & 0xff00ff) + ((is[i] & 0xff00) * i_77_ >> 8 & 0xff00);
		} while (--i_68_ > 0);
	    }
	}
    }
    ...
    public static final void method375(int i, int i_94_, int i_95_, int i_96_, int i_97_, int i_98_, int i_99_, int i_100_, int i_101_, int i_102_, int i_103_, int i_104_, int i_105_, int i_106_, int i_107_, int i_108_, int i_109_, int i_110_, int i_111_) {
	...
	if (i <= i_94_ && i <= i_95_) {
		...
		if (i_94_ < i_95_) {
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_94_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i, i_98_ >> 16, i_96_ >> 16, i_101_ >> 8, i_99_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_98_ += i_125_;
			    i_96_ += i_121_;
			    i_101_ += i_126_;
			    i_99_ += i_122_;
			...
			while (--i_95_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i, i_98_ >> 16, i_97_ >> 16, i_101_ >> 8, i_100_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_98_ += i_125_;
			    i_97_ += i_123_;
			    i_101_ += i_126_;
			    i_100_ += i_124_;
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_94_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i, i_96_ >> 16, i_98_ >> 16, i_99_ >> 8, i_101_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_98_ += i_125_;
			    i_96_ += i_121_;
			    i_101_ += i_126_;
			    i_99_ += i_122_;
			...
			while (--i_95_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i, i_97_ >> 16, i_98_ >> 16, i_100_ >> 8, i_101_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_98_ += i_125_;
			    i_97_ += i_123_;
			    i_101_ += i_126_;
			    i_100_ += i_124_;
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_95_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i, i_97_ >> 16, i_96_ >> 16, i_100_ >> 8, i_99_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_97_ += i_125_;
			    i_96_ += i_121_;
			    i_100_ += i_126_;
			    i_99_ += i_122_;
			...
			i = Rasterizer3D.lineOffsets[i];
			while (--i_95_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i, i_96_ >> 16, i_97_ >> 16, i_99_ >> 8, i_100_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_97_ += i_125_;
			    i_96_ += i_121_;
			    i_100_ += i_126_;
			    i_99_ += i_122_;
		...
		if (i_95_ < i) {
			...
			while (--i_95_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_94_, i_96_ >> 16, i_97_ >> 16, i_99_ >> 8, i_100_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_96_ += i_121_;
			    i_97_ += i_123_;
			    i_99_ += i_122_;
			    i_100_ += i_124_;
			...
			while (--i >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_94_, i_96_ >> 16, i_98_ >> 16, i_99_ >> 8, i_101_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_96_ += i_121_;
			    i_98_ += i_125_;
			    i_99_ += i_122_;
			    i_101_ += i_126_;
			...
			i_94_ = Rasterizer3D.lineOffsets[i_94_];
			while (--i_95_ >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_94_, i_97_ >> 16, i_96_ >> 16, i_100_ >> 8, i_99_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_96_ += i_121_;
			    i_97_ += i_123_;
			    i_99_ += i_122_;
			    i_100_ += i_124_;
			...
			while (--i >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_94_, i_98_ >> 16, i_96_ >> 16, i_101_ >> 8, i_99_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_96_ += i_121_;
			    i_98_ += i_125_;
			    i_99_ += i_122_;
			    i_101_ += i_126_;
			...
			i_94_ = Rasterizer3D.lineOffsets[i_94_];
			while (--i >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_94_, i_98_ >> 16, i_97_ >> 16, i_101_ >> 8, i_100_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_98_ += i_121_;
			    i_97_ += i_123_;
			    i_101_ += i_122_;
			    i_100_ += i_124_;
			...
			i_94_ = Rasterizer3D.lineOffsets[i_94_];
			while (--i >= 0) {
			    Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_94_, i_97_ >> 16, i_98_ >> 16, i_100_ >> 8, i_101_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			    i_98_ += i_121_;
			    i_97_ += i_123_;
			    i_101_ += i_122_;
			    i_100_ += i_124_;
		...
		if (i_123_ < i_125_) {
		    ...
		    while (--i >= 0) {
			Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_95_, i_97_ >> 16, i_98_ >> 16, i_100_ >> 8, i_101_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			i_97_ += i_123_;
			i_98_ += i_125_;
			i_100_ += i_124_;
			i_101_ += i_126_;
		    ...
		    while (--i_94_ >= 0) {
			Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_95_, i_97_ >> 16, i_96_ >> 16, i_100_ >> 8, i_99_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			i_97_ += i_123_;
			i_96_ += i_121_;
			i_100_ += i_124_;
			i_99_ += i_122_;
		    ...
		    i_95_ = Rasterizer3D.lineOffsets[i_95_];
		    while (--i >= 0) {
			Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_95_, i_98_ >> 16, i_97_ >> 16, i_101_ >> 8, i_100_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			i_97_ += i_123_;
			i_98_ += i_125_;
			i_100_ += i_124_;
			i_101_ += i_126_;
		    ...
		    while (--i_94_ >= 0) {
			Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_95_, i_96_ >> 16, i_97_ >> 16, i_99_ >> 8, i_100_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			i_97_ += i_123_;
			i_96_ += i_121_;
			i_100_ += i_124_;
			i_99_ += i_122_;
		...
		if (i_123_ < i_125_) {
		    ...
		    i_95_ = Rasterizer3D.lineOffsets[i_95_];
		    while (--i_94_ >= 0) {
			Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_95_, i_96_ >> 16, i_98_ >> 16, i_99_ >> 8, i_101_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			i_96_ += i_123_;
			i_98_ += i_125_;
			i_99_ += i_124_;
			i_101_ += i_126_;
		    ...
		    i_95_ = Rasterizer3D.lineOffsets[i_95_];
		    while (--i_94_ >= 0) {
			Rasterizer3D.method376(Rasterizer.pixels, is, 0, 0, i_95_, i_98_ >> 16, i_96_ >> 16, i_101_ >> 8, i_99_ >> 8, i_112_, i_115_, i_118_, i_113_, i_116_, i_119_);
			i_96_ += i_123_;
			i_98_ += i_125_;
			i_99_ += i_124_;
			i_101_ += i_126_;
    ...
    public static final void method376(int[] is, int[] is_133_, int i, int i_134_, int i_135_, int i_136_, int i_137_, int i_138_, int i_139_, int i_140_, int i_141_, int i_142_, int i_143_, int i_144_, int i_145_) {
	if (i_136_ < i_137_) {
	    int i_146_;
	    int i_147_;
	    if (Rasterizer3D.aBoolean1482) {
