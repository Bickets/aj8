...
public class ComplexTile
{
	...
	static int[] anIntArray215 = {
		1, 0
	};
	static int[] anIntArray216 = {
		2, 1
	};
	static int[] anIntArray217 = {
		3, 3
	};
	static final int[][] anIntArrayArray218 = {
		{
			1, 3, 5, 7
		}, {
			1, 3, 5, 7
	...
	static final int[][] anIntArrayArray219 = {
		{
			0, 1, 2, 3, 0, 0, 1, 3
		},
		{
	...
	public ComplexTile( int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_ )
	{
		try {
			...
			SignLink.reportError( "18048, " + i + ", " + i_0_ + ", " + i_1_ + ", " + i_2_ + ", " + i_3_ + ", " + i_4_ + ", " + i_5_ + ", " + i_6_ + ", " + i_7_ + ", " + i_8_ + ", " + i_9_ + ", " + i_10_ + ", " + i_11_ + ", " + i_12_ + ", " + i_13_ + ", " + i_14_ + ", " + i_15_ + ", " + i_16_ + ", " + i_17_ + ", " + i_18_ + ", " + runtimeexception.toString() );
