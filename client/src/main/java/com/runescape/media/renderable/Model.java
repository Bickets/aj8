...
public class Model extends Renderable {
		...
		for (int i_43_ = 0; i_43_ < i; i_43_++) {
			...
			if (model_44_ != null) {
				for (int i_45_ = 0; i_45_ < model_44_.triangleCount; i_45_++) {
					...
					trianglePointsX[triangleCount] = getFirstIdenticalVertexIndex(model_44_, model_44_.trianglePointsX[i_45_]);
					trianglePointsY[triangleCount] = getFirstIdenticalVertexIndex(model_44_, model_44_.trianglePointsY[i_45_]);
					trianglePointsZ[triangleCount] = getFirstIdenticalVertexIndex(model_44_, model_44_.trianglePointsZ[i_45_]);
					triangleCount++;
				}
				for (int i_47_ = 0; i_47_ < model_44_.texturedTriangleCount; i_47_++) {
					texturedTrianglePointsX[texturedTriangleCount] = getFirstIdenticalVertexIndex(model_44_, model_44_.texturedTrianglePointsX[i_47_]);
					texturedTrianglePointsY[texturedTriangleCount] = getFirstIdenticalVertexIndex(model_44_, model_44_.texturedTrianglePointsY[i_47_]);
					texturedTrianglePointsZ[texturedTriangleCount] = getFirstIdenticalVertexIndex(model_44_, model_44_.texturedTrianglePointsZ[i_47_]);
	...
	public Model(int i, boolean bool, Model[] models) {
	...
	public Model(boolean bool, boolean bool_72_, Model model) {
		vertexCount = model.vertexCount;
		triangleCount = model.triangleCount;
		texturedTriangleCount = model.texturedTriangleCount;
		if (bool) {
	...
	public void mixAnimationFrames(int[] is, int i_114_, int i_115_) {
		if (i_115_ != -1) {
			if (is == null || i_114_ == -1) {
