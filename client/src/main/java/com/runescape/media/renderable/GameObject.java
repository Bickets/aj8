...
public class GameObject extends Renderable {
	...
	public final Model getRotatedModel() {
		...
		Model model = gameObjectDefinition.getGameObjectModel(clickType, face, vertexHeight, vertexHeightRight, vertexHeightTopRight, vertexHeightTop, animation);
		return model;
	}
	...
	public GameObject(int id, int face, int clickType, int vertexHeightRight, int vertexHeightTopRight, int vertexHeight, int vertexHeightTop, int animationId, boolean bool) {
		this.id = id;
