 ...
 * <p>
 * <ul>
 * <li><strong>Windows:</strong> the ones people mostly associate with the word interfaces. Things
 * like your bank, the wildy warning screen, the trade screen, etc.</li>
 * <li><strong>Overlays:</strong> display in the same place as windows, but don't prevent you from
 * moving. For example, the wilderness level indicator.</li>
 ...
 * <li><strong>Fullscreen windows:</strong> a window which displays over the whole screen e.g. the
 * 377 welcome screen.</li>
 * <li><strong>Fullscreen background:</strong> an interface displayed behind the fullscreen window,
 * typically a blank, black screen.</li>
 * </ul>
 * @author Graham
 */
