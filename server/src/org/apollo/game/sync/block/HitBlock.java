...
/**
 * Represents the hit {@link SynchronizationBlock}. Both {@link Mob}'s and {@link Player}'s can
...
public final class HitBlock extends SynchronizationBlock
{
	 ...
	 *            The type of hit.
	 * @param currentHealth
	 *            The current health of the {@link org.apollo.game.model.Character}.
	 * @param maximumHealth
	 *            The maximum health of the {@link org.apollo.game.model.Character}.
	 */
