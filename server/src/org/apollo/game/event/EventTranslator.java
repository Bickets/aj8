...
import org.apollo.game.event.decoder.DialogueContinueEventDecoder;
...
import org.apollo.game.event.encoder.InterfaceItemModelEventEncoder;
import org.apollo.game.event.encoder.InterfaceModelAnimationEventEncoder;
import org.apollo.game.event.encoder.LogoutEventEncoder;
import org.apollo.game.event.encoder.MobModelOnInterfaceEventEncoder;
...
import org.apollo.game.event.handler.DialogueContinueEventHandler;
...
/**
 * The responsibility of this class is to translate registered {@link Event}'s
...
public final class EventTranslator {
    ...
    /**
     * Returns a decoded {@link Event} or {@code null} if the
     * {@link EventDecoder} does not exist for the specified packets opcode.
     * 
     ...
     * {@link EventEncoder} does not exist for the specified event's class.
     * 
    ...
    /**
     * Handles an {@link Event} for a specified {@link Player} if it exists by
     * the event's class.
     * 
