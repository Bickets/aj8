 ...
 */
@DecodesEvent(252)
public final class SecondObjectActionEventDecoder extends EventDecoder<ObjectActionEvent> {
	...
	return new ObjectActionEvent(InterfaceConstants.OPTION_TWO, id, new Position(x, y));
    }
