...
public final class SwitchItemEventHandler extends EventHandler<SwitchItemEvent>
{
	 ...
	 * @return The inventory for the specified interface id, {@code null} if not supported or does
	 *         not exist.
	 * @throws IllegalArgumentException If the specified interface id does not exist or is not
	 *             supported.
	 */
	...
	/**
	 * Returns {@code true} if the insert option is permitted for the specified interface id.
	 * @param id The interface id.
	 * @return {@code true} if inserting is permitted for the specified interface id, otherwise
	 *         return {@code false}.
	 */
