...
public final class Cache {
	 ...
	 *
	 * <p>
	 * Calculating the total size of a index file is
	 * <code>{@link Index#getFileId()} *
	 * {@link #INDEX_SIZE}</code>, the total size may be that of a {@code long}.
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * Calculating the total size of the sector header is
	 * <code>{@link Index#getFileId()} *
	 * {@link #SECTOR_HEADER_SIZE}</code>, the total size may be that of a
	 * {@code long}.
	 * </p>
	 */
	 ...
	 * Calculating the total size of the sector header is
	 * <code>{@link Index#getFileId()} *
	 * {@link #SECTOR_SIZE}</code>, the total size may be that of a {@code long}
	 * </p>
	 */
	...
	private Sector readSector(int sectorId, byte[] data, int offset, int length) throws IOException {
		...
		Sector sector = Sector.decode(buffer, data, offset, length);
		return sector;
	}
