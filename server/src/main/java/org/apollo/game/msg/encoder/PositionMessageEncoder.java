...
public final class PositionMessageEncoder implements MessageEncoder<PositionMessage> {
	...
	public GamePacket encode(PositionMessage msg) {
		...
		bldr.put(DataType.BYTE, DataTransformation.NEGATE, msg.getPosition().getLocalY(msg.getBase()));
		bldr.put(DataType.BYTE, DataTransformation.NEGATE, msg.getPosition().getLocalX(msg.getBase()));
