...
/**
 * Decodes the second {@link PlayerActionMessage}.
 *
 * @author Ryley Kimmel <ryley.kimmel@live.com>
 */
@DecodesMessage(153)
public final class SecondPlayerActionMessageDecoder implements MessageDecoder<PlayerActionMessage> {
	...
	public PlayerActionMessage decode(GamePacket packet) {
		...
		return new PlayerActionMessage(InteractContextMenuAction.ACTION_TWO, index);
	}
