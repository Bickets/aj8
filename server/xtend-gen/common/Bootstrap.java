...
public class Bootstrap {
  ...
  public void initSpawns(final World world) {
    ArrayList<Class<?>> _classes = this.classes("location");
    final Consumer<Class<?>> _function = new Consumer<Class<?>>() {
      public void accept(final Class<?> it) {
        try {
          Constructor<?> _constructor = it.getConstructor(World.class);
          Object _newInstance = _constructor.newInstance(world);
          final MobSpawn mob = ((MobSpawn) _newInstance);
          mob.spawn();
        } catch (Throwable _e) {
          throw Exceptions.sneakyThrow(_e);
        }
  ...
  public ArrayList<Class<?>> classes(final String dir) {
    ...
    final Iterable<String> filtered = IterableExtensions.<String>filter(((Iterable<String>)Conversions.doWrapArray(files)), _function);
