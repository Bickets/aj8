...
public final class EquipmentUpdater
{
	...
	private static final class EquipmentConstants
	{
		...
		public static final String[] HATS = {
			"helm", "hood", "coif", "Coif", "hat", "partyhat", "Hat",
			"full helm (t)", "full helm (g)", "hat (t)", "hat (g)", "cav",
			"boater", "helmet", "mask", "Helm of neitiznot"
		};
		...
		public static final String[] BODY = {
			"platebody", "chainbody", "robetop", "leathertop", "platemail",
			"top", "brassard", "Robe top", "body", "platebody (t)",
		 ...
		 * Legs.
		 */
		public static final String[] LEGS = {
		...
		public static final String[] WEAPONS = {
			...
			"mace", "halberd", "spear", "Abyssal whip", "axe", "flail",
			"crossbow", "Torags hammers", "dagger(p)", "dagger(+)",
		...
		public static final String[] FULL_HATS = {
			"med helm", "coif", "Dharoks helm", "hood", "Initiate helm",
		 ...
		 * Full masks.
		 */
		public static final String[] FULL_MASKS = {
			"full helm", "mask", "Veracs helm", "Guthans helm", "Torags helm",
